...
router.post('/bookings/:id/cancel', requireAuth, bookingController.cancel);

router.post('/bookings/:id/confirm', requireAuth, requireFrontDesk, bookingController.confirm);

router.post('/bookings/:id/check-in', requireAuth, requireFrontDesk, bookingController.checkIn);

router.post('/bookings/:id/check-out', requireAuth, requireFrontDesk, bookingController.checkOut);
