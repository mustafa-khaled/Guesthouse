...
router.post('/properties/:propertyId/rooms', requireAuth, requireManager, roomController.create);
...
router.patch('/rooms/:id/status', requireAuth, requireHousekeeping, roomController.updateStatus);

router.delete('/rooms/:id', requireAuth, requireManager, roomController.delete);
