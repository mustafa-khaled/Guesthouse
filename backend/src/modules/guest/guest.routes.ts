...
router.get('/guests/:id/bookings', requireAuth, requireFrontDesk, guestController.getBookings);

router.post('/guests/:id/link-user', requireAuth, requireFrontDesk, guestController.linkUser);
