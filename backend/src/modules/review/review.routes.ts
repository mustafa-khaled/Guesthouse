...
router.post('/reviews/:id/moderate', requireAuth, requireManager, reviewController.moderate);

router.post('/reviews/:id/respond', requireAuth, requireManager, reviewController.respond);
...
router.get('/properties/:propertyId/reviews/summary', reviewController.getPropertyRatingSummary);
