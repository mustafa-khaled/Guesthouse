...
export const bookingQueries = {
  mine: () =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: Booking[] }>('/v1/user/me/bookings'),
      select: (res) => res.data,
    }),
  ...
  availability: (params: Record<string, string>) =>
    queryOptions({
      ...
      queryFn: () => {
        const qs = new URLSearchParams(params).toString();
        return clientFetch<{ data: AvailabilityResult[] }>(`/v1/availability/search?${qs}`);
      },
...
export const roomTypeQueries = {
  byProperty: (propertyId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: RoomType[] }>(`/v1/properties/${propertyId}/room-types`),
      enabled: !!propertyId,
      select: (res) => res.data,
    }),
};
...
export const ratePlanQueries = {
  byRoomType: (roomTypeId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: RatePlan[] }>(`/v1/room-types/${roomTypeId}/rate-plans`),
      enabled: !!roomTypeId,
      select: (res) => res.data,
    }),
};
...
export const addOnQueries = {
  byProperty: (propertyId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: AddOn[] }>(`/v1/properties/${propertyId}/add-ons`),
      enabled: !!propertyId,
      select: (res) => res.data,
    }),
};
...
export const reviewQueries = {
  byProperty: (propertyId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: Review[] }>(`/v1/properties/${propertyId}/reviews`),
      enabled: !!propertyId,
      select: (res) => res.data,
    }),
  ...
  mine: () =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: Review[] }>('/v1/user/me/reviews'),
      select: (res) => res.data,
    }),
};
...
export const folioQueries = {
  byBooking: (bookingId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: Folio }>(`/v1/bookings/${bookingId}/folio`),
      enabled: !!bookingId,
      select: (res) => res.data,
    }),
};
...
export const paymentQueries = {
  byBooking: (bookingId: string) =>
    queryOptions({
      ...
      queryFn: () => clientFetch<{ data: Payment[] }>(`/v1/bookings/${bookingId}/payments`),
      enabled: !!bookingId,
      select: (res) => res.data,
    }),
};
